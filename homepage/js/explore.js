...
// Sürükleme (Drag) kodunun devamı (Eksikse ekle)
...
placesWrapper.addEventListener('mousemove', (e) => {
    ...
    // startX değişkenini yukarıda tanımlamıştın ama mousedown içinde değer atamayı unutma
    // Eğer çalışmazsa startX = e.pageX - placesWrapper.offsetLeft; satırını mousedown içine ekle
